...
# 3rd-Party Imports
# Local Imports
from .helpers import fix_ffmpeg_text, normalize_float, normalize_font_path
from .types import Dimension, Input, Output, Position, Seconds, Volume
...
class FFMPEG:
    ...
    def _compile_filter_complex(self) -> str:
        ...
        commands = commands.removesuffix(";")
    ...
    @RoundFloats()
    def add_input(self, input_file: str, start_from: float | None = None) -> FFMPEG:
        """
        Add an input file.
    ...
    def between(self, start: Seconds, end: Seconds) -> FFMPEG:
        ...
        output = re.search(r"(\[\w*];)", last_filter).groups()[0]
